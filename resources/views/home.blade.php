                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#katalog" class="menu-item">Katalog</a></li>                            
...
<!-- ***** Features Big Item End ***** -->
    ...
    <section class="section" id="katalog">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                ...
                <div class="features-item">
                    <div class="features-icon">
                        <h2></h2>
                        <img src="assets/images/{{ $k->icon }}" alt="">
                        <h4>{{ $k->nama_katalog }}</h4>
                        <p>{{ $k->deskripsi }}.</p>
                        <a href="#" onclick="return false" class="main-button">
                            IDR {{ $k->harga }}K
                        </a>
                    </div>
                </div>
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item service-item">
                            ...
                            <div class="testimonial-content">
                                ...
                                <p>“Nullam hedrerit, elit a semper pharetra, ipsum nibh tristique tortor, in tempus
